		...
		.authenticationEntryPoint(
			...
			.csrf().disable(). // disable CSRF to continue with REST APIs
				...
				.antMatchers("/products/view", 
						...
						"/users/signup",
						"/swagger*/**", 
						"/v*/api-docs/**","/vendor/add","/customer/add"
				...
				.antMatchers("/customer/update/{customerId}",
						"/customer/images",
						"/customer/{customerId}",
						"/customer/images/{customerId}",
						"/customer/delete/{customerId}").hasRole("CUSTOMER")// only customer can purchase the products
				.antMatchers("/vendor/update/{vendorId}/service/{serviceId}",
						"/vendor/update/{id}",
						"/vendor/images",
						"/vendor/{vendorId}",
						"/vendor/services/{vendorId}",
						"/vendor/service/{serviceId}",
						"/vendor/images/{vendorId}",
						"/vendor/delete/{vendorId}").hasRole("VENDOR") // only admin can add the products
